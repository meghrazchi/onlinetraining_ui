                ...
                <div className="row align-items-center justify-content-md-center justify-content-center">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-8">
                        <div className="text-center bg-white single-pricing-pack mt-4">
                            ...
                            <div className="pricing-content">
                                ...
                                <a href="#" className="btn btn-outline-brand-02 btn-rounded mb-3" target="_blank">Purchase
                                    now</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-6 col-sm-8">
                        <div className="popular-price bg-white text-center single-pricing-pack mt-4">
                            ...
                            <div className="pricing-content">
                                ...
                                <a href="#" className="btn btn-brand-02 btn-rounded mb-3" target="_blank">Purchase
                                    now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-12">
                        <div className="support-cta text-center mt-5">
                            <h5 className="mb-1"><span className="ti-headphone-alt color-primary mr-3"></span>We're Here
                                to Help You
                            </h5>
